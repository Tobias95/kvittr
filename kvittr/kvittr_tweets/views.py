...
from kvittr_tweets.models import Message
...
def message_listing(request):
    ...
    return render(request, 'kvittr_tweets/message_listing.html', context)
...
def message_details(request, post_id):
    ...
    return render(request, 'kvittr_tweets/message_details.html', context)    
